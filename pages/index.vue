...
<template>
    <div v-if="dataview">
        ...
        <div class="bg-zinc-900 h-full">
            ...
            fit
            for their school. Your academic writing skills and ability to follow a prompt are tested as the admissions
            officers look closely at your essays.Writing a 300-word college essay is intimidating, especially since
            that’s
            ...
            prepare for while starting the admissions process. To help you out, we have chosen two of the prompts to
            write a
            solid 300-word customized essay so you can get an idea of what you need to be writing. Check out the essay
            samples and a few essay writing tips below! Keep in mind, some colleges may require a longer essay while
            others
            may not, so pay attention to the word count for each specific topic.

            300-Word Essay Example 1
            Common App Prompt: The lessons we take from obstacles we encounter can be fundamental to later success.
            Recount
            ...
            Throughout high school, I had always excelled in academics. My mother is a college professor and my father
            is a
            teacher, so learning was instilled in me at a very young age. During my junior year (a monumental year for
            future college students), I faced a significant setback when I received a failing grade on a crucial exam in
            a
